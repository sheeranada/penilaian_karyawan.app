...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="/karyawan/{{ $karyawan->id }}" method="POST" class="was-validated">
                    @method('put')
                    @csrf
                    <div class="container">
                        <div class="row">
                            <div class="mb-3 col-lg-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="nama_karyawan" placeholder="input nama karyawan..." required value="{{ $karyawan->nama_karyawan }}">
                            ...
                            <div class="mb-3 col-sm-12 col-md-4">
                                ...
                                <select class="form-select form-select-lg-7 mb-3" name="unit_id" id="unit_id" required>
                                    <option selected value="{{ $karyawan->unit->id }}">{{ $karyawan->unit->nama_unit }}</option>
                                    @foreach ($unit as $u)
                            ...
                            <div class="mb-3 col-sm-12 col-md-4">
                                ...
                                <select class="form-select form-select-lg-7 mb-3" name="jkel" id="jkel" required>
                                    <option selected>{{ $karyawan->jkel}}</option>
                            ...
                            <div class="mb-3 col-lg-4 col-sm-12">
                                ...
                                <input type="number" class="form-control" id="nik" name="nik" rows="3" min="0" step="1" data-bind="value:replyNumber" required value="{{ $karyawan->nik }}">
                            </div>
                            <div class="valid-feedback">OK..</div>
