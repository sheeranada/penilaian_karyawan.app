    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Data Penilai</h3>
            </div>
            <div class="card-body">
                <form action="/penilai/store" method="POST" class="was-validated">
                    <div class="container">
                        <div class="row">
                            @csrf
                            ...
                            <div class="mb-3 col-lg-4 col-sm-12">
                                ...
                                <input type="number" class="form-control" id="kode_penilai" name="kode_penilai" rows="3" min="0" step="1" data-bind="value:replyNumber" required>
                                <div class="valid-feedback">OK..</div>
                            ...
                            <div class="mb-3 col-lg-8 col-sm-12">
                                ...
                                <select class="form-select form-select-lg-7 mb-3" name="nama_penilai" id="nama_penilai" required>
                                    <option selected disabled value="">-- pilih penilai --</option>
                                    @foreach ($karyawan as $k)
