...
<div class="content-wrapper">
    ...
    <section class="content">
        <a href="/penilai/create" class="btn btn-primary mb-3">TAMBAH DATA</a>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tabel Penilai</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        @foreach ($penilai as $no=>$p)
                        <tr>
                            <td align="center">{{ ++$no }}</td>
                            <td>{{ $p->karyawan->nama_karyawan }}</td>
                            <td>{{ $p->karyawan->jkel }}</td>
                            <td>{{ $p->karyawan->unit->nama_unit }}</td>
                            <td>{{ $p->kode_penilai }}</td>
                            <td>{{ $p->nama_penilai }}</td>
                            <td>
                                <div class="d-grid gap-2 d-md-block">
                                    <a href="/penilai/edit/{{ $p->id }}" class="btn btn-warning">
                                        <i class="fas fa-pencil-alt"></i> EDIT</a>
                                    <a href="/penilai/destroy/{{ $p->id }}" class="btn btn-danger">
