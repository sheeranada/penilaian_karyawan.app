...
<div class="content-wrapper">
    ...
    <section class="content">
        <a href="/unit/create" class="btn btn-primary mb-3">TAMBAH DATA</a>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tabel Unit / Bagian</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-grid gap-2 d-md-block">
                                    <a href="/unit/edit/{{ $u->id }}" class="btn btn-warning">
                                        <i class="fas fa-pencil-alt"></i> EDIT</a>
                                    <a href="/unit/destroy/{{ $u->id }}" class="btn btn-danger">
