...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="/user/store" method="POST" class="was-validated">
                    @csrf
                    <div class="row">
                        <div class="mb-3 col-lg-6 col-sm-12">
                            <label for="name" class="form-label">Nama</label>
                            <input name="name" type="text" class="form-control mb-3" id="name" placeholder="masukkan nama ..." required>
                        ...
                        <div class="mb-3 col-lg-6 col-sm-12">
                            ...
                            <input name="password" type="password" class="form-control mb-3" id="password" placeholder="masukkan password ..." required>
                            <div class="valid-feedback">OK..</div>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <a class="btn btn-primary" href="/user"><i class="fas fa-arrow-left"></i> BATAL</a>
